...
%   names               conc(ppb)               HoldMe 
    ...
    nHNO4               0                                           0;...          % Peng, here we only include gas phase of HNO3 but Peng only includes particulate phase.
...
fileoutput = [prefix, 'figures/', Flight_ID, '_CO_TS_', MECHANISM, '.png'];
...
fileoutput = [prefix, 'figures/', Flight_ID, '_BENZ_TS_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % Save the figure
...
fileoutput = [prefix, 'figures/', Flight_ID, '_NOx_TS_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % Save the figure
...
fileoutput = [prefix, 'figures/', Flight_ID, '_NO_TS_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % Save the figure
...
fileoutput = [prefix, 'figures/', Flight_ID, '_NO2_TS_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % Save the figure
...
fileoutput = [prefix, 'figures/', Flight_ID, '_', nFurans, '_TS_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % Save the figure
