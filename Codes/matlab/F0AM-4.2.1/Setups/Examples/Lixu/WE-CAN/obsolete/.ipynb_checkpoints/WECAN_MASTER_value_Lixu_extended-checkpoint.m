...
JN2O5_NO3_(s= met_obs.JN2O5_NO3_NO2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Duration: 6 hours (12pm to 6pm) with minutely resolution
duration = 6*60; % 360 minutes
o = ones(size(1:duration));

% Time structure
time.year           = 2018*o;
time.month          = 6*o;
time.day            = 1*o;
time.hour           = repelem(12:17, 60); % Repeat each hour 60 times
time.min            = repmat(0:59, 1, 6); % 0 to 59 for minutes, repeated 6 times
time.sec            = 0*o;
time.UTC            = -7; % UTC for Missoula during standard time

% Location structure for Missoula
location.latitude   = 46.8721;
location.longitude  = -113.9930;
location.altitude   = 978; % Altitude in meters
...
Met = {...
    ...
    'SZA'           SZA(starting_point:end)'         ;... %solar zenith angle, this is used for Jvalue calculation
    %'SZA'           90;... %solar zenith angle, missing!
    };
disp('done, provide met data');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ModelOptions.IntTime = 1200;       %integration time for each step, seconds. This needs to be customized, 900
%prefix = '/glade/u/home/lixujin/matlab/F0AM-4.2.1/Setups/Examples/Lixu/WE-CAN/'; %dummy for plotting
prefix = '';
ModelOptions.SavePath = ['/glade/u/home/lixujin/matlab/F0AM-4.2.1/Setups/Examples/Lixu/WE-CAN/output_data_extended/WECAN_', MECHANISM, Flight_ID];
...
fileoutput = [prefix, 'figures/', Flight_ID, '_O3_TS_ext', MECHANISM, '.png'];
