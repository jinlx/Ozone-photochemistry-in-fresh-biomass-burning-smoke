...
% test
% ---
PlotRates('CO14O3CHO',S,1000,'sumEq',1,'scale',1, 'saveout', 1, 'CO14O3CHO_rates_', Flight_ID, MECHANISM)
fileoutput = [prefix, 'figures/', Flight_ID, '_CO14O3CHO_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed


PlotRates('ACCOMECHO',S,1000,'sumEq',1,'scale',1, 'saveout', 1, 'ACCOMECHO_rates_', Flight_ID, MECHANISM)
fileoutput = [prefix, 'figures/', Flight_ID, '_ACCOMECHO_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
