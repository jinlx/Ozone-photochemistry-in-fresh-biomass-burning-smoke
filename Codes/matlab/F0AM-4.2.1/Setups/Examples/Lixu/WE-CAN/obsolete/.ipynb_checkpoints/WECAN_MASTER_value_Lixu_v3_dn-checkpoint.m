...
J_O3_O2_O1D = met_obs.J_O3_O2_O1D;
J_NO2_NO_O3P = met_obs.J_NO2_NO_O3P;
J_H2O2_2OH = met_obs.J_H2O2_2OH;
J_NO3_NO_O2 = met_obs.J_NO3_NO_O2;
J_NO3_NO2_O3P = met_obs.J_NO3_NO2_O3P;
J_N2O5_NO3_NO2 = met_obs.J_N2O5_NO3_NO2;
J_HNO2_OH_NO = met_obs.J_HNO2_OH_NO;
J_HNO3_OH_NO2 = met_obs.J_HNO3_OH_NO2;
J_HNO4_HO2_NO2UV_VISonly = met_obs.J_HNO4_HO2_NO2UV_VISonly;
J_CH2O_H_HCO = met_obs.J_CH2O_H_HCO;
J_CH2O_H2_CO = met_obs.J_CH2O_H2_CO;
J_CH3CHO_CH3_HCO = met_obs.J_CH3CHO_CH3_HCO;
J_Propanal_C2H5_HCO = met_obs.J_Propanal_C2H5_HCO;
J_CH3OOH_CH3O_OH = met_obs.J_CH3OOH_CH3O_OH;
J_MeONO2_CH3O_NO2 = met_obs.J_MeONO2_CH3O_NO2;
J_EthONO2_CH3CH2O_NO2 = met_obs.J_EthONO2_CH3CH2O_NO2;
J_CH3COOONO2_CH3COOO_NO2 = met_obs.J_CH3COOONO2_CH3COOO_NO2;
J_CH3COOONO2_CH3COO_NO3 = met_obs.J_CH3COOONO2_CH3COO_NO3;
J_MAC_Products = met_obs.J_MAC_Products;
J_MVK_Products = met_obs.J_MVK_Products;
J_Acetone_CH3CO_CH3 = met_obs.J_Acetone_CH3CO_CH3;
J_MEK_CH3CO_CH2CH3 = met_obs.J_MEK_CH3CO_CH2CH3;
J_Hydroxyacetone_CH3COO_CH3 = met_obs.J_Hydroxyacetone_CH3COO_CH3;
J_Hydroxyacetone_CH3CO_CH3O = met_obs.J_Hydroxyacetone_CH3CO_CH3O;
J_CHOCHO_HCO_HCO = met_obs.J_CHOCHO_HCO_HCO;
J_CHOCHO_H2_2CO = met_obs.J_CHOCHO_H2_2CO;
J_CHOCHO_CH2O_CO = met_obs.J_CHOCHO_CH2O_CO;
J_CH3COCHO_CH3CO_HCO = met_obs.J_CH3COCHO_CH3CO_HCO;
J_23Butanedione_Products = met_obs.J_23Butanedione_Products;
J_Cl2_Cl_Cl = met_obs.J_Cl2_Cl_Cl;
J_ClO_Cl_O3P = met_obs.J_ClO_Cl_O3P;
J_ClNO2_Cl_NO2 = met_obs.J_ClNO2_Cl_NO2;
J_ClONO_Cl_NO2 = met_obs.J_ClONO_Cl_NO2;
J_ClONO2_Cl_NO3 = met_obs.J_ClONO2_Cl_NO3;
J_ClONO2_ClO_NO2 = met_obs.J_ClONO2_ClO_NO2;
J_Br2_Br_Br = met_obs.J_Br2_Br_Br;
J_BrO_Br_O = met_obs.J_BrO_Br_O;
J_HOBr_OH_Br = met_obs.J_HOBr_OH_Br;
J_BrNO_Br_NO = met_obs.J_BrNO_Br_NO;
J_BrONO_Br_NO2 = met_obs.J_BrONO_Br_NO2;
J_BrONO_BrO_NO = met_obs.J_BrONO_BrO_NO;
J_BrNO2_Br_NO2 = met_obs.J_BrNO2_Br_NO2;
J_BrONO2_BrO_NO2 = met_obs.J_BrONO2_BrO_NO2;
J_BrONO2_Br_NO3 = met_obs.J_BrONO2_Br_NO3;
J_BrCl_Br_Cl = met_obs.J_BrCl_Br_Cl;
J_CHBr3_Products = met_obs.J_CHBr3_Products;
...
% Apply the removal for each variable using the specified format
PRESSURE(:, bad_point) = [];
TEMPERATURE(:, bad_point) = [];
RHUM(:, bad_point) = [];
SZA(:, bad_point) = [];
J_O3_O2_O1D(:, bad_point) = [];
J_NO2_NO_O3P(:, bad_point) = [];
J_H2O2_2OH(:, bad_point) = [];
J_NO3_NO_O2(:, bad_point) = [];
J_NO3_NO2_O3P(:, bad_point) = [];
J_N2O5_NO3_NO2(:, bad_point) = [];
J_HNO2_OH_NO(:, bad_point) = [];
J_HNO3_OH_NO2(:, bad_point) = [];
J_HNO4_HO2_NO2UV_VISonly(:, bad_point) = [];
J_CH2O_H_HCO(:, bad_point) = [];
J_CH2O_H2_CO(:, bad_point) = [];
J_CH3CHO_CH3_HCO(:, bad_point) = [];
J_Propanal_C2H5_HCO(:, bad_point) = [];
J_CH3OOH_CH3O_OH(:, bad_point) = [];
J_MeONO2_CH3O_NO2(:, bad_point) = [];
J_EthONO2_CH3CH2O_NO2(:, bad_point) = [];
J_CH3COOONO2_CH3COOO_NO2(:, bad_point) = [];
J_CH3COOONO2_CH3COO_NO3(:, bad_point) = [];
J_MAC_Products(:, bad_point) = [];
J_MVK_Products(:, bad_point) = [];
J_Acetone_CH3CO_CH3(:, bad_point) = [];
J_MEK_CH3CO_CH2CH3(:, bad_point) = [];
J_Hydroxyacetone_CH3COO_CH3(:, bad_point) = [];
J_Hydroxyacetone_CH3CO_CH3O(:, bad_point) = [];
J_CHOCHO_HCO_HCO(:, bad_point) = [];
J_CHOCHO_H2_2CO(:, bad_point) = [];
J_CHOCHO_CH2O_CO(:, bad_point) = [];
J_CH3COCHO_CH3CO_HCO(:, bad_point) = [];
J_23Butanedione_Products(:, bad_point) = [];
J_Cl2_Cl_Cl(:, bad_point) = [];
J_ClO_Cl_O3P(:, bad_point) = [];
J_ClNO2_Cl_NO2(:, bad_point) = [];
J_ClONO_Cl_NO2(:, bad_point) = [];
J_ClONO2_Cl_NO3(:, bad_point) = [];
J_ClONO2_ClO_NO2(:, bad_point) = [];
J_Br2_Br_Br(:, bad_point) = [];
J_BrO_Br_O(:, bad_point) = [];
J_HOBr_OH_Br(:, bad_point) = [];
J_BrNO_Br_NO(:, bad_point) = [];
J_BrONO_Br_NO2(:, bad_point) = [];
J_BrONO_BrO_NO(:, bad_point) = [];
J_BrNO2_Br_NO2(:, bad_point) = [];
J_BrONO2_BrO_NO2(:, bad_point) = [];
J_BrONO2_Br_NO3(:, bad_point) = [];
J_BrCl_Br_Cl(:, bad_point) = [];
J_CHBr3_Products(:, bad_point) = [];
...
Met = {...
    ...
    nJCH3CHO        J_CH3CHO_CH3_HCO(starting_point:end)';... % CH3CHO-->CH3+HCO
    nJC2H5CHO       J_Propanal_C2H5_HCO(starting_point:end)';...% C2H5CHO-->C2H5+HCO
    nJCH3OOH        J_CH3OOH_CH3O_OH(starting_point:end)';...%CH3OOH-->CH3O+OH
    nJCH3COCH3      J_Acetone_CH3CO_CH3(starting_point:end)';...%CH3COCH3 -->CH3CO+CH3
    nJMEK           J_MEK_CH3CO_CH2CH3(starting_point:end)';...%MEK -->CH3CO+CH2CH3
    nJCHOCHO_H2     J_CHOCHO_H2_2CO(starting_point:end)';...%CHOCHO-->H2+2CO
    nJCHOCHO_CH2O   J_CHOCHO_CH2O_CO(starting_point:end)';...%CHOCHO-->CH2O+CO
    nJCHOCHO_HCO    J_CHOCHO_HCO_HCO(starting_point:end)';...%CHOCHO-->HCO+HCO
    nJCH3COCHO      J_CH3COCHO_CH3CO_HCO(starting_point:end)';...%CH3COCHO-->CH3CO+HCO
    nJBIACET        J_23Butanedione_Products(starting_point:end)';...%BIACET->BIACET
...
%   names               conc(ppb)               HoldMe 
    ...
    % Furans  
    nFurans         (smk_FURAN_C4H4O_PTR(starting_point) + smk_2_Methylfuran_C5H6O_PTR(starting_point) + ...
...
%   names               values
    ...
    % Furans   
    nFurans             min(bkg_FURAN_C4H4O_PTR)+min(bkg_3_Methylfuran_C5H6O_PTR)+...
...
PlotRatesAvg('MALDIALO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MALDIALO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('C5DICARBO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C5DICARBO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('DMKOHO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_DMKOHO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
...
PlotRatesAvg('MALDIALPAN',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MALDIALPAN_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('C5COO2NO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C5COO2NO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('MALANHY',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MALANHY_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('MALDIALOOH',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MALDIALOOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('C5DICAROOH',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C5DICAROOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('DMKOHOOH',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_DMKOHOOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

% Fifth genration reactions
PlotRatesAvg('MALANHYO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MALANHYO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed


% Furfurals
PlotRatesAvg('FURFURAL',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_Furfural_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('MEFURFURAL',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_MEFURFURAL_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('HYDFURFURALO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_HYDFURFURALO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('HYDMEFURFURALO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_HYDMEFURFURALO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('C5DIALCO',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C5DIALCO_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('C5MCO3DB',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C5MCO3DB_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('BZFUOOH',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_BZFUOOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

% ------
% ACR
% ------
PlotRatesAvg('ACR',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_ACR_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
%PlotRatesAvg('OCCOHCO2',S,5); % if HO2 is the major one, then consider to include the path. Ignore it otherwise.
%fileoutput = [prefix, 'figures/', Flight_ID, '_OCCOHCO2_rates_', MECHANISM, '.png'];
%saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('ACRO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_ACRO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('ACO3',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_ACO3_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('ACRPAN',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_ACRPAN_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

% -------------
% 1,3-butadiene
% -------------
PlotRatesAvg('C4H6',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C4H6_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('BUTDAO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_BUTDAO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('BUTDBO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_BUTDBO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('BUTDCO2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_BUTDCO2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('HC3CHO',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_HC3CHO_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg('C41O2',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_C41O2_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
PlotRatesAvg('HC3CO3',S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_HC3CO3_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
%}
%Save_rates;
%{
switch MECHANISM
    case {'MCMv331_base', 'MCMv331_GCvocs', 'MCMv331_noFUR', 'MCMv331_GCvocsF', 'MCMv331_extension'}
        PlotRatesAvg('HOCH2CH2O',S,5);
        fileoutput = [prefix, 'figures/', Flight_ID, '_HOCH2CH2O_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
    otherwise
        disp('skip as it is not in the GEOS-Chem')
end

PlotRatesAvg(nCSL,S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_CSL_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed

PlotRatesAvg(nPHEN,S,5);
fileoutput = [prefix, 'figures/', Flight_ID, '_PHEN_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput); % do not forget to save out the figure otherwise it cannot be displayed
%}

PlotRates(nC2H4,S,1000,'sumEq',1,'scale',1, 'saveout', 1, 'unit', 'ppb_h', 'C2H4_rates_', Flight_ID, MECHANISM)
fileoutput = [prefix, 'figures/', Flight_ID, '_C2H4_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
