...
%   names               conc(ppb)               HoldMe 
    ...
    %NOy 
    'NO'                 smk_NO(starting_point)*ScaleFacNOx                      0;...          % Peng
    'NO2'                smk_NO2(starting_point)*ScaleFacNOx                     0;...          % Peng
...
% Time
obs_time = (Age_physical_avg_min-Age_physical_avg_min(starting_point)).*60; % aging corrected
mod_time = S.Time;
smk_CO = smk_CO_QCL;
smk_O3 = smk_O3;

%disp(Sd.Conc.(nFURAN)(1:4));

plotting_comp; % comment it out if you don't want plotting
