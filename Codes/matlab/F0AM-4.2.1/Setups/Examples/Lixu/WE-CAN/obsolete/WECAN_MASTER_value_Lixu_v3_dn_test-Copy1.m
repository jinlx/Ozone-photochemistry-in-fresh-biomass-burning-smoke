...
% BENZ
% ----
PlotRatesAvg(nBENZ,S,5,'sumEq',1,'unit','ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_BENZ_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed

% ----
% TOLU
% ----
PlotRatesAvg(nTOLU,S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_TOLU_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% XYLE
% ----
%PlotRatesAvg(nXYLE,S,5,'sumEq',1, 'unit', 'ppb_h');
%fileoutput = [prefix, 'figures/', Flight_ID, '_XYLE_rates_', MECHANISM, '.png'];
%saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% ISOP
% ----
PlotRatesAvg(nISOP,S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_ISOP_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% MOH
% ----
PlotRatesAvg(nMOH,S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_MOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% EOH
% ----
PlotRatesAvg(nEOH,S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_EOH_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% ACET
% ----
PlotRatesAvg(nACET,S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_ACET_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% MEK
% ----
PlotRatesAvg('MEK',S,5,'sumEq',1, 'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_MEK_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% PHEN
% ----
PlotRatesAvg(nPHEN,S,5,'sumEq', 1,'unit', 'ppb_h');
fileoutput = [prefix, 'figures/', Flight_ID, '_PHEN_rates_', MECHANISM, '.png'];
saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
% ----
% CSL
% ----
PlotRatesAvg(nCSL,S,5,'sumEq', 1,'unit', 'ppb_h');
...
switch MECHANISM
    case {'MCMv331_base', 'MCMv331_GCvocs', 'MCMv331_noFUR', 'MCMv331_GCvocsF', 'MCMv331_extension'}
        ...
        % FURAN
        % ------
        PlotRatesAvg(nFURAN,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_FURAN_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % -------
        % M2FURAN
        % -------
        PlotRatesAvg(nM2FURAN,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_M2FURAN_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ----------
        % DIMEFURAN
        % ----------
        PlotRatesAvg(nDIMEFURAN,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_DIMEFURAN_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % --------
        % FURFURAL
        % --------
        PlotRatesAvg(nFURFURAL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_FURFURAL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ----------
        % MEFURFURAL
        % ----------
        PlotRatesAvg(nMEFURFURAL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_MEFURFURAL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % -------
        % BZFUONE
        % -------
        PlotRatesAvg(nBZFUONE,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_BZFUONE_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ----
        % C4H6
        % ----
        PlotRatesAvg(nC4H6,S,5,'sumEq', 1,'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_C4H6_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ------
        % C4ALDB
        % ------
        PlotRatesAvg(nC4ALDB,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_C4ALDB_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % --------
        % GUAIACOL
        % --------
        PlotRatesAvg(nGUAIACOL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_GUAIACOL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % -------
        % STYRENE
        % -------
        PlotRatesAvg(nSTYRENE,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_STYRENE_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ------
        % OXYLAL
        % ------
        PlotRatesAvg(nOXYLAL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_OXYLAL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % ---------
        % MGUAIACOL
        % --------
        PlotRatesAvg(nMGUAIACOL,S,5,'sumEq',1,'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_MGUAIACOL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % --------
        % SYRINGOL
        % --------
        PlotRatesAvg(nSYRINGOL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_SYRINGOL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        % -----
        % BCARY
        % -----
        PlotRatesAvg(nBCARY,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_BCARY_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
        %}
        % -----
        % CATECHOL
        % -----
        PlotRatesAvg(nCATECHOL,S,5,'sumEq',1, 'unit', 'ppb_h');
        fileoutput = [prefix, 'figures/', Flight_ID, '_CATECHOL_rates_', MECHANISM, '.png'];
        saveas(gcf, fileoutput) % do not forget to save out the figure otherwise it cannot be displayed
