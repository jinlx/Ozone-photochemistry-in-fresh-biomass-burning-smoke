...
XO2names = [S3.Cnames(S3.iRO2);'HO2']; % lxu, RO2 + HO2
[~,iNO]  = ismember('NO',S3.Cnames); %index location of species, lxu, iNO is what we need
[~,iNO2] = ismember('NO2',S3.Cnames);% lxu, iNO2 is what we need
[~,iXO2] = ismember(XO2names,S3.Cnames); % lxu, iXO2 is what we need
