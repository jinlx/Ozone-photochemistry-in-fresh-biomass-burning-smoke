...
FALD      {Generic aldehdye products from furans oxidation including MALDIAL (majority, put it as individial), HOHOC4DIAL; C5DICARB; C4DBDIKET; C5DIALCO} # This is the one we need to consider about thoroughly
FURANRO2 {Generic peroxy radical from furans oxidation including HYDFURANO2; C5HYDCARBO2; FURFURALO2, HYDFURFURALO2, ALDFURFURALO2(this probably need to be put individually)} 
HYDMEFURANRO2 {Generic hydroperoxide radical from methyl furans including HYDMEFURANO2, HYDDIMEFURANO2, and HYDMEFURFURALO2}, producing MANHYDRIDE
...
i=i+1;
Rnames{i} = 'FALDCO3 + NO = 0.4GLYX + 0.4CO + 0.6MANHYDRIDE + NO2';
k(:,i) = KAPNO;
Gstr{i,1} = 'FALDCO3'; Gstr{i,2} = 'NO'; 
fFALDCO3(i)=fFALDCO3(i)-1; fNO(i)=fNO(i)-1; fGLYX(i)=fGLYX(i)+0.4; fCO(i)=fCO(i)+0.4; fMANHYDRIDE(i)=fMANHYDRIDE(i)+0.6; fNO2(i)=fNO2(i)+1;
...
k(:,i) = GCARR_abc(T, 9.5E13, 0.0, -5988.0);%20220223, Lixu, fix the bug.
Gstr{i,1} = 'ETO'; 
