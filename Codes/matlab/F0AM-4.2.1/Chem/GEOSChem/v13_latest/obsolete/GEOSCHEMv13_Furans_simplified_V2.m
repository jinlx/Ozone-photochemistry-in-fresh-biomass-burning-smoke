...
FURAN + OH = 0.7MALDIAL + 0.7HO2 + 0.3HYDFURANRO2 (k = 4.2e-11) 
    ...
    HYDFURANO2 + NO = MALDALCO2H + NO2 + HO2
        MALDALCO2H + OH = 0.4(GLYOX + HO2 + CO) + 0.6(MALANHY + HO2) (k = 3.7e-11)
        

M2FURAN + OH = 0.7HYDFURANRO2 + 0.3MALDIAL (k = ) # lump C5HYDCARBO2 and HYDMEFURANO2 as HYDFURANRO2, assume C5DICARB as MALDIAL but add yield of MGLY
...
FURAN + OH = 0.7FALD+ 0.7HO2 + 0.3FURANRO2 (k = 4.2e-11)                                                           # haven't weighted glyxoal and divide products into number of C   
    FALD + OH = 0.83FALDCO3 + 0.17FURANRO2 (k = 5.20e-11)
        FALDCO3 + MO2 = 0.7*(0.4GLYX + 0.4CO + 0.6MANHYDRIDE) + 0.3*FALDCO2H (k = 1.00e-11)                         # assuming RO2 as MO2;
            ...
            FALDCO2H + hv = GLYCO2H + HO2 + CO + HO2 + CO # JMACR
