...
RO2ToAdd = {'MO2', 'A3O2', 'AROMRO2', 'ATO2', 'BRO2', ...
                     'BZCO3', 'C4HVP1', 'C4HVP2', ...
...
%disp('This is for NO')
%disp(GCJPLPR_abab(M, T, 7.00E-31, 2.6E+00, 3.60E-11, 0.1, 0.6));
%disp('This is for NO2')
%disp(GCJPLPR_aba(M, T, 1.80E-30, 3.0E+00, 2.8E-11, 0.6));
%exit()
...
k(:,i) = 1.33E-13 + 3.82E-11.*exp(-2000.0./T); % fix the bug by add dot before either / or *
...
k(:,i) = 3.15e-12.*exp(-450./T); % Lixu, 04/03/2023, this is from MCM
...
% comment out the photolysis since it is not included in the MCM and I may match the wrong J value in the model.
%i=i+1;
