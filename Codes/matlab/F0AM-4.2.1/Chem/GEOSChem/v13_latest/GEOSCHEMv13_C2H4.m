...
'CH2OOA'; 'HOCH2CH2O2'; 'CH2OO'; 'HYETHO2H'; 'ETHOHNO3'; 'HOCH2CH2O'; 'ETHGLY'; 'HOCH2CHO'; 'HOCH2CO3'; 'HOCH2CO2H'; 'HOCH2CO3H'};

% Lixu, add C4H6 + OH, and lumped BUTDAO2, BUTDBO2, and BUTDCO2 into C4H6O2 
% Lixu, add ACR + OH, and lumped ACO3, ACRO2, and OCCOHCO2 into ACRO2 
% See 24 reactions and corresponding speices in the list. Details in Lixu_C3H6_box_model.pptx
% add Furans rxns from MCM
...
%}
% MCM related C2H4 chemsitry 
i=i+1;
Rnames{i} = 'C2H4 + O3 = CH2O + CH2OOA';
k(:,i) = 9.1e-15.*exp(-2580./T);
Gstr{i,1} = 'C2H4'; Gstr{i,2} = 'O3'; 
fC2H4(i)=fC2H4(i)-1; fO3(i)=fO3(i)-1; fCH2O(i)=fCH2O(i)+1; fCH2OOA(i)=fCH2OOA(i)+1; 
...
i=i+1;
Rnames{i} = 'HOCH2CH2O = HO2 + CH2O + CH2O';
k(:,i) = 9.50e13.*exp(-5988./T);
Gstr{i,1} = 'HOCH2CH2O'; 
fHOCH2CH2O(i)=fHOCH2CH2O(i)-1; fHO2(i)=fHO2(i)+1; fCH2O(i)=fCH2O(i)+1; fCH2O(i)=fCH2O(i)+1; 
...
i=i+1;
Rnames{i} = 'HOCH2CHO + OH = GLYX + HO2';
k(:,i) = 1.00e-11.*0.200;
Gstr{i,1} = 'HOCH2CHO'; Gstr{i,2} = 'OH'; 
fHOCH2CHO(i)=fHOCH2CHO(i)-1; fOH(i)=fOH(i)-1; fGLYX(i)=fGLYX(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1;
Rnames{i} = 'HOCH2CHO + hv = HO2 + CH2O + HO2 + CO';
k(:,i) = JGLYC;
Gstr{i,1} = 'HOCH2CHO'; 
fHOCH2CHO(i)=fHOCH2CHO(i)-1; fHO2(i)=fHO2(i)+1; fCH2O(i)=fCH2O(i)+1; fHO2(i)=fHO2(i)+1; fCO(i)=fCO(i)+1; 

%%%%% HOCH2CO3
i=i+1;
Rnames{i} = 'HOCH2CO3 + HO2 = HO2 + CH2O + OH';
k(:,i) = KAPHO2.*0.44;
Gstr{i,1} = 'HOCH2CO3'; Gstr{i,2} = 'HO2'; 
fHOCH2CO3(i)=fHOCH2CO3(i)-1; fHO2(i)=fHO2(i)-1; fHO2(i)=fHO2(i)+1; fCH2O(i)=fCH2O(i)+1; fOH(i)=fOH(i)+1; 
...
i=i+1;
Rnames{i} = 'HOCH2CO3 + NO = NO2 + HO2 + CH2O';
k(:,i) = KAPNO;
Gstr{i,1} = 'HOCH2CO3'; Gstr{i,2} = 'NO'; 
fHOCH2CO3(i)=fHOCH2CO3(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; fCH2O(i)=fCH2O(i)+1; 

% assuming PHAN as PAN
i=i+1;
Rnames{i} = 'HOCH2CO3 + NO2 = PAN';
k(:,i) = KFPAN;
Gstr{i,1} = 'HOCH2CO3'; Gstr{i,2} = 'NO2'; 
fHOCH2CO3(i)=fHOCH2CO3(i)-1; fNO2(i)=fNO2(i)-1; fPAN(i)=fPAN(i)+1; 

i=i+1;
Rnames{i} = 'HOCH2CO3 + NO3 = NO2 + HO2 + CH2O';
k(:,i) = KRO2NO3.*1.74;
Gstr{i,1} = 'HOCH2CO3'; Gstr{i,2} = 'NO3'; 
fHOCH2CO3(i)=fHOCH2CO3(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; fCH2O(i)=fCH2O(i)+1; 

i=i+1;
Rnames{i} = 'HOCH2CO3 + RO2 = CH2O + HO2';
k(:,i) = 1.00e-11.*0.7;
Gstr{i,1} = 'HOCH2CO3'; Gstr{i,2} = 'RO2';
fHOCH2CO3(i)=fHOCH2CO3(i)-1; fCH2O(i)=fCH2O(i)+1; fHO2(i)=fHO2(i)+1; 
...
%%%%% HOCH2CO2H and HOCH2CO3H
i=i+1;
Rnames{i} = 'HOCH2CO2H + OH = CH2O + HO2';
k(:,i) = 2.73e-12;
Gstr{i,1} = 'HOCH2CO2H'; Gstr{i,2} = 'OH'; 
fHOCH2CO2H(i)=fHOCH2CO2H(i)-1; fOH(i)=fOH(i)-1; fCH2O(i)=fCH2O(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1;
Rnames{i} = 'HOCH2CO3H + hv = CH2O + HO2 + OH';
k(:,i) = JCH3OOH;
Gstr{i,1} = 'HOCH2CO3H'; 
fHOCH2CO3H(i)=fHOCH2CO3H(i)-1; fCH2O(i)=fCH2O(i)+1; fHO2(i)=fHO2(i)+1; fOH(i)=fOH(i)+1; 
