...
MALANHY    = IGNORE; {C4H2O3; Maleic anhydride}, here we use AROMP4 instead as it is included in Kelvin's mechanism.
%}
i=i+1;
...
i=i+1;
Rnames{i} = 'FURFURAL + hv = C2H4 + CO + CO';
k(:,i) = JFURFURAL.*0.85;
Gstr{i,1} = 'FURFURAL'; 
fFURFURAL(i)=fFURFURAL(i)-1; fC2H4(i)=fC2H4(i)+1; fCO(i)=fCO(i)+1; fCO(i)=fCO(i)+1; 
...
i=i+1;
Rnames{i} = 'DIALCO2 = 0.38GLYX + 0.01MGLY + 0.61AROMP4 + 0.04MO2 + 0.96HO2 + 0.39CO';
k(:,i) = KDEC; 
Gstr{i,1} = 'DIALCO2';
fDIALCO2(i)=fDIALCO2(i)-1; fGLYX(i)=fGLYX(i)+0.38; fMGLY(i)=fMGLY(i)+0.01; fAROMP4(i)=fAROMP4(i)+0.61; fMO2(i)=fMO2(i)+0.04; fHO2(i)=fHO2(i)+0.96; fCO(i)=fCO(i)+0.39;
