...
QY{i} = 0; % Assume for 254 nm lights

i=i+1;
Jnames{i} = 'J6'; % NO3 -> NO2 + O
CS{i} = 'Cross_Section_NO3_254nm.csv'; % normally @Cross_Section_NO3;
...
QY{i} = 0.3; %Assume for 254 nm light, normally @Quantum_Yield_CH3CHO_CH3;
...
QY{i} = 0.21 ; % assume value observed at higher photolysis.  normally @Quantum_Yield_C3H7CHO_C3H7;

i=i+1;
Jnames{i} = 'J16'; % C3H7CHO -> C2H4 + CH3CHO
CS{i} = 'Cross_Section_C3H7CHO.csv';
QY{i} = 0.1 ; % assume same as at 254. normally @Quantum_Yield_C3H7CHO_C2H4;

i=i+1;
Jnames{i} = 'J17'; % IPRCHO -> n-C4H9 + HCO
CS{i} = 'Cross_Section_IPRCHO.csv';
QY{i} = 0.25; %assume for 254 nm light, normally 'Quantum_Yield_IPRCHO.csv';

i=i+1;
Jnames{i} = 'J18'; % MACR -> CH2=CCH3 + HCO
CS{i} = 'Cross_Section_MACR.csv';
% QY{i} = 0.00195; % MCM value
QY{i} = 0.05; % JPL upper limit at 270 nm. Normally 0.005
...
QY{i} = 0.42; %assume for 254 nm light, normally @Quantum_Yield_CH3COCH3_CH3CO;
...
QY{i} = 1; %assume for 254 nm. Normally @Quantum_Yield_MGLYOX; 
...
i=i+1;
Jnames{i} = 'J57';  % FURFURAL -> Products... (Ignore this for now... in the "non MCM" ones too) % change J58 into J57 makes it work.
CS{i} = 'Cross_Section_FURFURAL.csv';
QY{i} = 0.6;
% hold for now, Lixu
i=i+1;
Jnames{i} = 'J59';  % Benzaldehyde -> Products...(Ignore this for now... in the "non MCM" ones too)
...
CS{i} = 'Cross_Section_CH3CHO.csv';
QY{i} = 0.46 ; % lower limit at 255. normally @Quantum_Yield_CH3CHO_CH4;

i=i+1;
Jnames{i} = 'Jn6'; % CH3CHO->CH3CO+H
CS{i} = 'Cross_Section_CH3CHO.csv';
QY{i} = 0.12 ; % lower limit at 255. normally @Quantum_Yield_CH3CHO_CH3CO;


i=i+1;
Jnames{i} = 'Jn7';  % FURFURAL -> Products...
CS{i} = 'Cross_Section_FURFURAL.csv';
QY{i} = 0.6;
...
CS{i} = @Cross_Section_CH3COCH3;
QY{i} = 0.2 ; %lower limit IUPAC for 254 nm, normally @Quantum_Yield_CH3COCH3_CO;
