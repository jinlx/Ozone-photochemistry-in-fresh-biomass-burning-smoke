function [SpRates, ax] = PlotRates_ID(Spname,S,n2plot,varargin)
% Lixu, 11/08/2022, passing the ID to save files in different places.
...
ParsePairs(varargin(1:end-2),varInfo);
...
%%%%%OUTPUT%%%%%
%if nargout % Lixu, 20220318, commented
    ...
    Flight_ID = varargin{5};
    MECHANISM = varargin{6};
    switch Flight_ID
        case {'FN06', 'FN19'}
            filename = ['/glade/u/home/lixujin/matlab/F0AM-4.2.1/Setups/Examples/Lixu/FIREX-AQ/output_data/pltrate', MECHANISM, Flight_ID];
            save(filename, '-struct', 'SpRates');
            disp('save out required SpRates data');
        case {'RF03', 'RF07', 'RF09'}
            filename = ['/glade/u/home/lixujin/matlab/F0AM-4.2.1/Setups/Examples/Lixu/WE-CAN/output_data/pltrate', MECHANISM, Flight_ID];
            save(filename, '-struct', 'SpRates');
            disp('save out required SpRates data');
        case {'P3B'}
            filename = ['/glade/u/home/lixujin/matlab/F0AM-4.2.1/Setups/Examples/Lixu/P-3B/output_data/pltrate', MECHANISM, Flight_ID];
            save(filename, '-struct', 'SpRates');
            disp('save out required SpRates data');
        otherwise
    end   
