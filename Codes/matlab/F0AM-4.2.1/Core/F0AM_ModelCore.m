...
conc_init(:,2) = sum(conc_init(:,Chem.iRO2),2); %RO2 is second species % Lixu, if it suggests error in this step, it may indicate we include the wrong RO2 in the mechanism
